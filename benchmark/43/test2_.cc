...
#include "src/base/strings.h"#include "src/codegen/macro-assembler.h"
...
class V8_EXPORT_PRIVATE RegExpMacroAssemblerRISCV
 ...
 public:
  ...
  virtual void CheckNotCharacterAfterAnd(uint32_t c, uint32_t mask,
                                         Label* on_not_equal);
  virtual void CheckNotCharacterAfterMinusAnd(base::uc16 cbase::uc16 minusbase::uc16 mask, 
                                              Label* on_not_equal);
  virtual void CheckCharacterInRange(base::uc16 from, base::uc16 to, Label* on_in_range);
