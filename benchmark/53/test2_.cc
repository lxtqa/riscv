...
void RegExpMacroAssemblerRISCV::CheckCharacterLT( uc16  limit,
                                                 Label* on_less) {
...
void RegExpMacroAssemblerRISCV::CheckNotCharacterAfterMinusAnd( uc16 c,  uc16 minus,  uc16 mask,  Label* on_not_equal) {
...
void RegExpMacroAssemblerRISCV::CheckCharacterInRange( uc16  from,
                                                       uc16  to,
                                                      Label* on_in_range) {
